...
class EAN13Renderer:
    ...
    def __init__(self, code, left_bars, right_bars, guards, font=ImageFont.load_default().font):
        self.code = code
    ...
    def get_pilimage(self, bar_width):
        ...
        draw.text((1 * bar_width, int(image_height * 0.8)),
                  self.code[0], font=self.font)
        draw.text((16 * bar_width, int(image_height * 0.8)),
                  self.code[1:7], font=self.font)
        draw.text((63 * bar_width, int(image_height * 0.8)), self.code[7:], font=self.font)
