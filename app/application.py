    ...
    def keyPressEvent(self, event):
        ...
        if key in (Qt.Key_Return, Qt.Key_Enter):
            ...
            if info.get('state') == 0:
                ...
                QtWidgets.QMessageBox.warning(self, '异常', '获取数据错误:%s' % info.get('msg'))
        else:
            QtWidgets.QLineEdit.keyPressEvent(self, event)


xiaomi_print_69 = XiaoMiPrinter_69()
aqara_print_69 = AqaraPrinter_69()

printer = {
    '米家69码打印': xiaomi_print_69,
    'Aqara69码打印': aqara_print_69,
}
